...
def decode_cop2_special(opcode: int, addr: int) -> Instruction:
    ...
    match op:
        case 0x00 | 0x01 | 0x02 | 0x03:
            instruction.name = "vaddbc"
        case 0x04 | 0x05 | 0x06 | 0x07:
            instruction.name = "vsubbc"
        case 0x08 | 0x09 | 0x0A | 0x0B:
            instruction.name = "vmaddbc"
        case 0x0C | 0x0D | 0x0E | 0x0F:
            instruction.name = "vmsubbc"
        case 0x10 | 0x11 | 0x12 | 0x13:
            instruction.name = "vmaxbc"
        case 0x14 | 0x15 | 0x16 | 0x17:
            instruction.name = "vminibc"
...
def decode_cop2_special2(opcode: int, addr: int) -> Instruction:
    ...
    match op:
        case 0x00 | 0x01 | 0x02 | 0x03:
            instruction.name = "vaddabc"
        case 0x04 | 0x05 | 0x06 | 0x07:
            instruction.name = "vsubabc"
        case 0x08 | 0x09 | 0x0A | 0x0B:
            instruction.name = "vmaddabc"
        case 0x0C | 0x0D | 0x0E | 0x0F:
            instruction.name = "vmsubabc"
        case 0x10:
